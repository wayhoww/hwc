...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // array_dims
      char dummy3[sizeof (ptr_list_of<const_exp_t>)];

      // const_array_elements
      char dummy4[sizeof (ptr_list_of<const_init_val_t>)];

      // array_dims_func_param
      // array_dims_func_param_real
      // array_indices
      // func_r_params_elements
      char dummy5[sizeof (ptr_list_of<exp_t>)];
      ...
      // add_exp
      char dummy8[sizeof (std::shared_ptr<add_exp_t>)];
      ...
      // exp
      char dummy21[sizeof (std::shared_ptr<exp_t>)];

      // func_def
      char dummy22[sizeof (std::shared_ptr<func_def_t>)];

      // func_f_param
      char dummy23[sizeof (std::shared_ptr<func_f_param_t>)];

      // func_f_params
      char dummy24[sizeof (std::shared_ptr<func_f_params_t>)];

      // func_r_params
      char dummy25[sizeof (std::shared_ptr<func_r_params_t>)];

      // ident
      char dummy26[sizeof (std::shared_ptr<ident_t>)];

      // init_val
      char dummy27[sizeof (std::shared_ptr<init_val_t>)];

      // l_and_exp
      char dummy28[sizeof (std::shared_ptr<l_and_exp_t>)];

      // l_or_exp
      char dummy29[sizeof (std::shared_ptr<l_or_exp_t>)];

      // l_val
      char dummy30[sizeof (std::shared_ptr<l_val_t>)];

      // mul_exp
      char dummy31[sizeof (std::shared_ptr<mul_exp_t>)];

      // number
      char dummy32[sizeof (std::shared_ptr<number_t>)];

      // primary_exp
      char dummy33[sizeof (std::shared_ptr<primary_exp_t>)];

      // rel_exp
      char dummy34[sizeof (std::shared_ptr<rel_exp_t>)];

      // stmt
      char dummy35[sizeof (std::shared_ptr<stmt_t>)];

      // unary_exp
      char dummy36[sizeof (std::shared_ptr<unary_exp_t>)];

      // var_decl
      char dummy37[sizeof (std::shared_ptr<var_decl_t>)];

      // var_def
      char dummy38[sizeof (std::shared_ptr<var_def_t>)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_func_f_param = 56,                     // func_f_param
        S_array_dims_func_param = 57,            // array_dims_func_param
        S_array_dims_func_param_real = 58,       // array_dims_func_param_real
        S_block = 59,                            // block
        S_block_elements = 60,                   // block_elements
        S_block_item = 61,                       // block_item
        S_ident = 62,                            // ident
        S_stmt = 63,                             // stmt
        S_exp = 64,                              // exp
        S_cond = 65,                             // cond
        S_l_val = 66,                            // l_val
        S_array_indices = 67,                    // array_indices
        S_primary_exp = 68,                      // primary_exp
        S_number = 69,                           // number
        S_unary_exp = 70,                        // unary_exp
        S_func_r_params = 71,                    // func_r_params
        S_func_r_params_elements = 72,           // func_r_params_elements
        S_mul_exp = 73,                          // mul_exp
        S_add_exp = 74,                          // add_exp
        S_rel_exp = 75,                          // rel_exp
        S_eq_exp = 76,                           // eq_exp
        S_l_and_exp = 77,                        // l_and_exp
        S_l_or_exp = 78,                         // l_or_exp
        S_const_exp = 79                         // const_exp
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_func_r_params_elements: // func_r_params_elements
        value.move< ptr_list_of<exp_t> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_add_exp: // add_exp
        value.move< std::shared_ptr<add_exp_t> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_exp: // exp
        value.move< std::shared_ptr<exp_t> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_ident: // ident
        value.move< std::shared_ptr<ident_t> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_mul_exp: // mul_exp
        value.move< std::shared_ptr<mul_exp_t> > (std::move (that.value));
        break;

      case symbol_kind::S_number: // number
        value.move< std::shared_ptr<number_t> > (std::move (that.value));
        break;

      case symbol_kind::S_primary_exp: // primary_exp
        value.move< std::shared_ptr<primary_exp_t> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_unary_exp: // unary_exp
        value.move< std::shared_ptr<unary_exp_t> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ptr_list_of<exp_t>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ptr_list_of<exp_t>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<add_exp_t>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<add_exp_t>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<exp_t>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<exp_t>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<ident_t>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<ident_t>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<mul_exp_t>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<mul_exp_t>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<number_t>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<number_t>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<primary_exp_t>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<primary_exp_t>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<unary_exp_t>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<unary_exp_t>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      ...
      case symbol_kind::S_array_indices: // array_indices
      case symbol_kind::S_func_r_params_elements: // func_r_params_elements
        value.template destroy< ptr_list_of<exp_t> > ();
        break;
      ...
      case symbol_kind::S_add_exp: // add_exp
        value.template destroy< std::shared_ptr<add_exp_t> > ();
        break;
      ...
      case symbol_kind::S_exp: // exp
        value.template destroy< std::shared_ptr<exp_t> > ();
        break;
      ...
      case symbol_kind::S_ident: // ident
        value.template destroy< std::shared_ptr<ident_t> > ();
        break;
      ...
      case symbol_kind::S_mul_exp: // mul_exp
        value.template destroy< std::shared_ptr<mul_exp_t> > ();
        break;

      case symbol_kind::S_number: // number
        value.template destroy< std::shared_ptr<number_t> > ();
        break;

      case symbol_kind::S_primary_exp: // primary_exp
        value.template destroy< std::shared_ptr<primary_exp_t> > ();
        break;
      ...
      case symbol_kind::S_unary_exp: // unary_exp
        value.template destroy< std::shared_ptr<unary_exp_t> > ();
        break;
    ...
    , value ()
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_array_indices: // array_indices
      case symbol_kind::S_func_r_params_elements: // func_r_params_elements
        value.copy< ptr_list_of<exp_t> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_add_exp: // add_exp
        value.copy< std::shared_ptr<add_exp_t> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_exp: // exp
        value.copy< std::shared_ptr<exp_t> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_ident: // ident
        value.copy< std::shared_ptr<ident_t> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_mul_exp: // mul_exp
        value.copy< std::shared_ptr<mul_exp_t> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_number: // number
        value.copy< std::shared_ptr<number_t> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_primary_exp: // primary_exp
        value.copy< std::shared_ptr<primary_exp_t> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_unary_exp: // unary_exp
        value.copy< std::shared_ptr<unary_exp_t> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_array_indices: // array_indices
      case symbol_kind::S_func_r_params_elements: // func_r_params_elements
        value.move< ptr_list_of<exp_t> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_add_exp: // add_exp
        value.move< std::shared_ptr<add_exp_t> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_exp: // exp
        value.move< std::shared_ptr<exp_t> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_ident: // ident
        value.move< std::shared_ptr<ident_t> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_mul_exp: // mul_exp
        value.move< std::shared_ptr<mul_exp_t> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_number: // number
        value.move< std::shared_ptr<number_t> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_primary_exp: // primary_exp
        value.move< std::shared_ptr<primary_exp_t> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_unary_exp: // unary_exp
        value.move< std::shared_ptr<unary_exp_t> > (YY_MOVE (s.value));
        break;
